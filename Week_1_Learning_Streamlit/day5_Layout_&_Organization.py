...
if uploaded_file:
    ...
    st.sidebar.write("Columns in the dataset:", df.columns.tolist())
    ...
    st.sidebar.info("our slider range has type: %s" %type(age_filter))
    ...
    with st.expander("View Filtered Dataset", expanded=True):
    ...
    with col2:
        ...
        st.subheader("Purchase Amount (USD) vs Age")
