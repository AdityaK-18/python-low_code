...
# App title
st.title("College Conference Event Management App with Cookies")

# Left menu dropdown
menu = ["Add Event", "View Events", "Upload Kaggle Dataset", "Visualize Data", "Clear Cookies"]
...
elif choice == "Clear Cookies":
    st.subheader("Clear Cookies")
    if st.button("Clear Cookies"):
        cookies.clear()
        st.success("Cookies cleared. Refresh the page.")
